...
#if !defined(HAVE_XENOMAI_THREADS) 
    #if !defined(HAVE_XENOMAI_KERNEL_THREADS)
        #error "This driver is for Xenomai only."
    #endif
#endif
